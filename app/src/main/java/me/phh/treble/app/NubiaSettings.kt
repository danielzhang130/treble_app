...
object NubiaSettings : Settings {
    ...
    override fun enabled() = Tools.vendorFp.lowercase().startsWith("nubia/")
    fun is6Series() = Tools.vendorFp.lowercase().startsWith("nubia/nx669")
    fun is5GLite() = Tools.vendorFp.lowercase().startsWith("nubia/nx651")
    fun is5G5S() = Tools.vendorFp.lowercase().startsWith("nubia/nx659")
